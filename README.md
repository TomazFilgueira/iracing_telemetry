...
1. **Initialization**: Run `start_telemetry.bat` from the project root after Iracing **opened**. This will automatically:
...
3. **Termination**: Run `stop_telemetry.bat` once your stint is complete. This script will:
